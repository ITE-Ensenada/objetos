...
def verificador(arreglo):
    ...
    por decirlo asi, primero compara el 1 con el 2, despues el 2 con el 3, y asi, hasta encontrar que el primer elemento sea mayor
    y altera la bandera, si la bandera se mantiene el arreglo se imprimira como esta, si no se ordenara e imprimira el arreglo """
    orden=0
    n = len(arreglo)
    for i in range(n-1):
