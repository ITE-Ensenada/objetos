...
def verificador(arreglo):
    """este verificador utiliza la funcion sorted() para comprovar si la lista esta ordenada,
    si la lista esta ordenada se imprimira la lista
    si no se ordenara y se imprimira la lista"""
